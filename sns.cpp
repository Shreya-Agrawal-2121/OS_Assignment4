...
void *userSimulator(void *args){
    ...
    while(1){
        ...
        string logFileName = "userSimulator.log";
    ...
    if (logFile.is_open()) {
     // write to the log file
         logFile << "Logging started at " << dt << endl;
        logFile << msg << endl;

    // close the log file
        logFile.close();
        cout << "Logged to file: " << logFileName << endl;
     }
    else {
    cout << "Failed to open userSimulator log file." << endl;
    }
...
void *readPost(void *args){
    while(1){ 
        ...
        string logFileName = "readPost.log";
        ofstream logFile(logFileName);
        cout << logFile.is_open() << endl;
        if (logFile.is_open()) {
        // write to the log file
        logFile << "Logging started at " << dt << endl;
        logFile << msg << endl;
        ...
        cout << "Logged to file: " << logFileName << endl;
           ...
           cout << "Failed to open openPost log file." << endl;
        }
        pthread_mutex_unlock(&tlock);
